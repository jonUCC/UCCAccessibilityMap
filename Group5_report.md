...
| Task | Completed by |
| ---------------------------------------------- | ----------------- |
| Project suggestions | Each Individually |
| Voting | Each |
| Reconnaissance (walking campus routes) | Jack |
| Guided Recon | James |
| Similar Project Research | James |
| Free Map API research | Gavin |
| Javascript Library Research | Gavin |
| Building geometry acquired from Overpass Turbo | Gavin |
| Floor Plans acquired | Gavin |
| Manual slope calculations | Gavin |
| Investigate routing tools | Gavin |
| Evaluate possible storage systems | Gavin |
| Initial routing feasibility investigation | Gavin |
| Accessibility considerations research | Gavin |

### System Design

| Task | Completed by |
| ----------------- | ------------- |
| OpenStreetMap proposed & accepted | Gavin |
| Leaflet proposed & accepted | Gavin |
| Open Source Routing Machine proposed & accepted | Gavin |
...
| GeoJSON schema for building data designed | Gavin |
| GraphHopper local server architecture designed | Gavin |
| Accessibility hazard dataset structure designed | Gavin |
| Routing system architecture designed | Gavin |
...
| Identified OSRM vehicle-only routing limitation | Gavin |
| Evaluated alternative routing engines | Gavin |
| Implemented GraphHopper routing engine | Gavin |
| GraphHopper local routing server setup | Gavin |
| Created GraphHopper configuration file | Gavin |
| OSM dataset preparation for routing | Gavin |
| Modified OSM dataset for accessibility features | Gavin |
| Integrated GraphHopper routing with frontend | Gavin |
...
| Added wheelchair accessibility metadata to buildings | Gavin |
| Added building opening hours dataset | Gavin |
| Implemented building popup information system(broken) | Gavin |
...
| Repository branch management and pull requests | Gavin |
| GraphHopper elevation data integration | Gavin |
| Generated and optimised GraphHopper routing graph | Gavin |
| GraphHopper server configuration tuning | Gavin |
| Implemented accessibility route selection interface | Gavin |
| Integrated route hazard highlighting | Gavin |
...
| Task | Completed by |
| -------------------------------- | ------------ |
| Accessibility routing validation | Gavin |
| Hazard detection testing | Gavin |
| Frontend route rendering tests | Gavin |
| Map data accuracy checks | Gavin |
| Implemented accessibility route selection interface | Gavin |
| Debugged routing marker state issues | James |
...
| Task | Completed by |
| ------------------------------------- | ------------ |
| GitHub repository organisation | Gavin |
| GraphHopper server setup instructions | Gavin |
| Project documentation | Gavin |
| README documentation | Gavin |
| Repository preparation for submission | Gavin |
